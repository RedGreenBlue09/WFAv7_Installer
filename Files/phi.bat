...
cd /D %~dp0\..\
cls
title Windows 10 Installer for Lumia 920
...
:: Device's Driver
Dism /Image:N:\ /Add-Driver /Driver:".\drivers\components\DEVICE.SOC_QC8960.PHI" /Recurse
...
Dism /Image:N:\ /Add-Driver /Driver:".\drivers\components\PLATFORM.SOC_QC8960.SOC8960AA" /Recurse
