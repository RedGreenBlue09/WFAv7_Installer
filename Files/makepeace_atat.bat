...
cd /D %~dp0\..\
cls
title Windows 10 Installer for Lumia 640 XL AT^&T Variation
echo ---------------------- Windows 10 for ARMv7 Installer by RedGreenBlue123 ----------------------
echo.
echo  - For Lumia 640 XL AT^&T Variation
...
:: Device's Driver
Dism /Image:N:\ /Add-Driver /Driver:".\drivers\configurations\devices\specifics-makepeaceatt" /Recurse
:: MSM8974's Driver
