...
cd /D %~dp0\..\
cls
title Windows 10 Installer for Lumia 1020 AT^&T
echo ---------------------- Windows 10 for ARMv7 Installer by RedGreenBlue123 ----------------------
echo.
echo  - For Lumia 1020 AT^&T
...
:: Device's Driver
Dism /Image:N:\ /Add-Driver /Driver:".\drivers\components\DEVICE.SOC_QC8960.EOSATT" /Recurse
Dism /Image:N:\ /Add-Driver /Driver:".\drivers\components\OEM.SOC_QC8960.NMO" /Recurse
Dism /Image:N:\ /Add-Driver /Driver:".\drivers\components\DEVICE.INPUT.SYNAPTICS_RMI4 /Recurse
:: MSM8X26's Driver
Dism /Image:N:\ /Add-Driver /Driver:".\drivers\components\PLATFORM.SOC_QC8960.BASE" /Recurse
Dism /Image:N:\ /Add-Driver /Driver:".\drivers\components\PLATFORM.SOC_QC8960.SOC8960AB" /Recurse
