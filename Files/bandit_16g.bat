...
cd %~dp0\..\
cls
title Windows 10 Installer for Lumia 1520 (16GB)
echo ---------------------- Windows 10 for ARMv7 Installer by RedGreenBlue123 ----------------------
echo.
echo  - For Lumia 1520 (16GB)
...
: Device's Driver
Dism /Image:N:\ /Add-Driver /Driver:".\drivers\configurations\devices\specifics-bandit" /Recurse
: MSM8974's Driver
